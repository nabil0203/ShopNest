...
urlpatterns = [
    ...
    path('products/', views.product_list, name="product_list"),                                                         # All Product List
    path('products/<slug:category_slug>/', views.product_list, name="product_list_by_category"),                        # All Product List By Category 
